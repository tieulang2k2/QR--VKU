...
Future<List<Course>> fetchProfessorCourses(String professorId,
    {bool isToday = false}) async {
  // Gọi API để lấy danh sách lớp học phần
  // professorId = '1';
  var courseListUrl = '';
  if (isToday) {
    courseListUrl = '$BASE_URL/officer/todayTeachingSchedule/$professorId';
    // Kiểm tra ngày hiện tại có trùng với ngày của lớp học không
  } else {
    courseListUrl = '$BASE_URL/officer/course/$professorId';
  }

...
import 'package:vku_app/services/Course/CourseService.dart';
...
class CourseScreenStudent extends StatefulWidget {
  ...
  const CourseScreenStudent({super.key, required this.studentCode});
...
class _CourseScreenStudentState extends State<CourseScreenStudent> {
  ...
  void initState() {
    super.initState();
    todayCourses = fetchStudentCourses(widget.studentCode, isToday: true);
    allCourses = fetchStudentCourses(widget.studentCode);
    objects = Future.wait([todayCourses, allCourses]).then((values) {
    return Tuple2(values[0], values[1]);
  });
    // studentListFuture = getCourses(studentCode);
  }
    ...
    return Scaffold(
      ...
      builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            debugPrint('currentCoures: $currentCoures - allCourses: $allCourses');
                        ...
                        child: ConstrainedBox(
                          ...
                          child: DataTable(
                            ...
                            columns: const [
                              ...
                              DataColumn(label: Text('Lich trình môn học')),
                            ],
                            rows: List.generate(
                                  ...
                                  cells: [
                                    ...
                                    DataCell(
                                      ElevatedButton(
                                        ...
                                        child: const Text('Xem lịch trình'),
                                      ),
                                    ), // Trạng thái
                                  ],
                                );
                          ...
                          child: ConstrainedBox(
                              ...
                              child: DataTable(
                                ...
                                columns: const [
                                  ...
                                  DataColumn(label: Text('Thứ / Tiết')),
                                  DataColumn(label: Text('Lịch trình môn học')),
                                ],
                                // List<Course>
                                rows: List.generate(
                                  allCourses.length,
